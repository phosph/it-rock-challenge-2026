...
describe('guestGuard', () => {
  ...
  it('should redirect to /feed when user is authenticated', async () => {
    setup();
  ...
  it('should redirect to /feed when token exists and getCurrentUser succeeds', async () => {
    setup();
  ...
  it('should return true when not authenticated and no token', async () => {
    setup();
  ...
  it('should return true when token exists but getCurrentUser fails', async () => {
    setup();
